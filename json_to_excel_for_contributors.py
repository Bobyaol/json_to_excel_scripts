...
# #2_0##############################################################################################################
    ...
    for index_2_0, i_2_0 in enumerate(total_content.items()):
        first_half_dict_2_0[i_2_0[1]['user_id']] = {}
        first_half_dict_2_0[i_2_0[1]['user_id']]['user_id'] = i_2_0[1]['user_id']
        first_half_dict_2_0[i_2_0[1]['user_id']]['user_name'] = i_2_0[1]['user_name']
    ...
    for index_2_0_, i_2_0_ in enumerate(total_content.items()):
        ...
        second_half_dict_2_0[index_2_0_]['user_id'] = i_2_0_[1]['user_id']
    ...
    for i_2_0 in second_half_dict_2_0.items():
        # print(f"i_2_0 = {i_2_0}")
        first_dict = first_half_dict_2_0[i_2_0[1]['user_id']]
...
# #2_1##############################################################################################################
    ...
    for index_2_1, i_2_1 in enumerate(total_content.items()):
        first_half_dict_2_1[i_2_1[1]['user_id']] = {}
        first_half_dict_2_1[i_2_1[1]['user_id']]['user_id'] = i_2_1[1]['user_id']
        first_half_dict_2_1[i_2_1[1]['user_id']]['user_name'] = i_2_1[1]['user_name']
    ...
    for index_2_1_, i_2_1_ in enumerate(total_content.items()):
        ...
        for metric in metrics:
            ...
            second_half_dict_2_1[metric_index]['user_id'] = metric['user_id']
    ...
    for i_2_1 in second_half_dict_2_1.items():
        # print(f"i_2_1 = {i_2_1}")
        first_dict = first_half_dict_2_1[i_2_1[1]['user_id']]
        # print(f"first_dict = {first_dict}")
...
# #2_2##############################################################################################################
    ...
    for index_2_2, i_2_2 in enumerate(total_content.items()):
        first_half_dict_2_2[i_2_2[1]['user_id']] = {}
        first_half_dict_2_2[i_2_2[1]['user_id']]['user_id'] = i_2_2[1]['user_id']
        first_half_dict_2_2[i_2_2[1]['user_id']]['user_name'] = i_2_2[1]['user_name']
    ...
    for index_2_2_, i_2_2_ in enumerate(total_content.items()):
        ...
        second_half_dict_2_2[index_2_2_]['user_id'] = i_2_2_[1]['user_id']
    ...
    for i_2_2 in second_half_dict_2_2.items():
        # print(f"i_2_2 = {i_2_2}")
        first_dict = first_half_dict_2_2[i_2_2[1]['user_id']]
        # print(f"first_dict = {first_dict}")
